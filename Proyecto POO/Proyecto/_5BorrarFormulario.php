...
<body style="background-color: #E8CA33;">
    <div style="text-align: center;">
        <form method="POST" action="_5Aplicacio.php">
           ...
           <br /><br /> <label for="texto">Si desea eliminar la informacion del formulario en base de datos, escria la palabra ELIMINAR. </label><br /><br />
            <input type="text" name="eliminarInfo" id="eliminarInfo" placeholder="ELIMINAR" /><br /><br />
